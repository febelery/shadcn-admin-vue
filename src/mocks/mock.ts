...
const mockArticles = [
  ...
  },
  {
    ...
    views: 890,
    cover:
      'https://images.pexels.com/photos/4164418/pexels-photo-4164418.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&dpr=1',
  ...
  },
  {
    ...
    views: 2100,
    cover:
      'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&dpr=1',
  ...
  mock.onGet('/users').reply((config) => {
    ...
    if (search) {
      filteredUsers = filteredUsers.filter(
        (user) => user.name.includes(search) || user.email.includes(search) || user.username.includes(search)
      )
    }
  ...
  mock.onGet('/articles').reply((config) => {
    ...
    if (search) {
      filteredArticles = filteredArticles.filter(
        (article) => article.title.includes(search) || article.excerpt.includes(search)
      )
    }
