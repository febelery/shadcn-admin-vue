...
class X2TConverter {
  ...
  private readonly SCRIPT_PATH = 'https://cbgccdn.thecover.cn/onlyoffice/wasm/x2t/x2t.js'
      ...
      return new Promise((resolve, reject) => {
        ...
        x2t.onRuntimeInitialized = () => {
          try {
            ...
            console.error('X2T initialization failed:', error)
            reject(error)
          }
        }
      })
...
export const convertBinToDocumentAndDownload = (bin: Uint8Array, fileName: string, targetExt?: string) =>
